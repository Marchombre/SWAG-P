...
def simulate_reflectance(lambda_range, geometry, wave, df_config, json_path_expdata, n_mod):
    """
    ...
    for lam in lambda_range:
        ...
        materials = build_material_configuration_dynamic(df_config, lam, json_path_expdata)
