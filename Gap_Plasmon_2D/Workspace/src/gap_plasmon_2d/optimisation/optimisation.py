...
Usage dans l’application interactive :
    from gap_plasmon_2d.optimisation.optimisation import create_optimization_tab
...
from gap_plasmon_2d.utils.data_readers import read_optimization_hdf5, list_optimization_files
...
BASE_NOTEBOOKS     = Path(__file__).resolve().parent.parent / str(paths.RESULTS_DIR)
...
class OptimizationTab:
    def __init__(self, sim_obj: SimulationTab):
        ...
        self.summary_opt_dir = (
            ...
            / str(paths.RESULTS_DIR) / "summary_optimisation"
        )
    ...
    def DE_general(self, *, budget, Npop, lowers, uppers, keys, mode="dip", n_jobs=-1):
        """
        ...
        n_jobs = -1 pour utiliser tous les cœurs dispo.
        """
